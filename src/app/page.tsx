    ...
    <main className="min-h-screen bg-black p-6">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-4 rounded-xl border p-4">
          <div className="h-[520px] overflow-y-auto rounded-lg border bg-gray p-4">
              ...
              {messages.map((m) => (
                ...
                >
                  <div className="max-w-[75%] rounded-lg border p-3">
                    <div className="text-xs text-green-500">{m.role}</div>
          ...
          <div className="mt-3 text-sm text-white-600">
